...
def main_application():
	...
	splash.show()
	# splash.showMessage(
	# 	"<h1><font color='white'; font-weight: bold;>Жесткая система ОДУ</font></h1>" +  \
	# 	"<h1><font color='white'; font-weight: bold;>Ксения Белова / Игорь Сумин</font></h1>", \
